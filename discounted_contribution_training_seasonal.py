...
from src.algorithms.rl import EnergyCommunityDiscountedContributionPriorityV0
...
temp_env = EnergyCommunityDiscountedContributionPriorityV0(ren_generators=generators,
                                                           generators=[],
                                                           loads=loads,
                                                           storages=storages,
                                                           evs=evs,
...
env = EnergyCommunityDiscountedContributionPriorityV0(ren_generators=generators,
                                                      generators=[],
                                                      loads=loads,
                                                      storages=storages,
                                                      evs=evs,
                                                      ...
                                                      seed=42,
                                                      is_training=True)
register_env("EC_DiscountedContrib_V0", lambda config: env)

# Define the PPOConfig
_config = (PPOConfig()
           .environment(env="EC_DiscountedContrib_V0", disable_env_checking=False)

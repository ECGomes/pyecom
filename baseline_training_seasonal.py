...
from src.algorithms.rl import EnergyCommunityBaselineV7
...
temp_env = EnergyCommunityBaselineV7(ren_generators=generators,
                                     generators=[],
                                     loads=loads,
                                     storages=storages,
                                     evs=evs,
...
env = EnergyCommunityBaselineV7(ren_generators=generators,
                                generators=[],
                                loads=loads,
                                storages=storages,
                                evs=evs,
                                ...
                                seed=42,
                                is_training=True)
register_env("EC_Baseline_V7", lambda config: env)

# Define the PPOConfig
_config = (PPOConfig()
           .environment(env="EC_Baseline_V7", disable_env_checking=False)

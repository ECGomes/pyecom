...
from src.algorithms.rl import EnergyCommunityWindowedContributionPriorityV0
...
temp_env = EnergyCommunityWindowedContributionPriorityV0(ren_generators=generators,
                                                         generators=[],
                                                         loads=loads,
                                                         storages=storages,
                                                         evs=evs,
...
env = EnergyCommunityWindowedContributionPriorityV0(ren_generators=generators,
                                                    generators=[],
                                                    loads=loads,
                                                    storages=storages,
                                                    evs=evs,
                                                    ...
                                                    seed=42,
                                                    is_training=True)
register_env("EC_Windowed_Contrib_V0", lambda config: env)

# Define the PPOConfig
_config = (PPOConfig()
           .environment(env="EC_Windowed_Contrib_V0", disable_env_checking=False)

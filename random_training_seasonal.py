...
from src.algorithms.rl import EnergyCommunityRandomPriorityV0
...
temp_env = EnergyCommunityRandomPriorityV0(ren_generators=generators,
                                           generators=[],
                                           loads=loads,
                                           storages=storages,
                                           evs=evs,
...
env = EnergyCommunityRandomPriorityV0(ren_generators=generators,
                                      generators=[],
                                      loads=loads,
                                      storages=storages,
                                      evs=evs,
                                      ...
                                      seed=42,
                                      is_training=True)
register_env("EC_Random_V0", lambda config: env)

# Define the PPOConfig
_config = (PPOConfig()
           .environment(env="EC_Random_V0", disable_env_checking=False)

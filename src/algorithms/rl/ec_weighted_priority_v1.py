...
class EnergyCommunityWeightedPriorityV1(MultiAgentEnv):
    """
    ...
    metadata = {'name': 'EnergyCommunityWeightedPriority-v1'}
    ...
    def _reset(self):
        ...
        contribution_dict = self.create_contribution_dict()
        self.priority_system.update_resources(contribution_dict, self.timestep)

...
from src.priorities import DiscountedContributionPriority
...
class EnergyCommunityDiscountedContributionPriorityV0(MultiAgentEnv):
    """
    ...
    def _reset(self):
        ...
        if self.timestep == 0:
            ...
            self.priority_system = DiscountedContributionPriority(self.storages + self.evs,
                                                                  log_scaling=False)

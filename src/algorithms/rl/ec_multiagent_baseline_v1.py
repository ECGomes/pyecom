...
class EnergyCommunityBaselineV1(MultiAgentEnv):
    """
    ...
    def __create_ren_gen_actions__(self) -> dict:
        ...
        for gen in self.ren_generators:
            generator_actions[gen.name] = gym.spaces.Dict({
                'production': gym.spaces.Box(low=1.0, high=1.0, shape=(1,), dtype=np.float32)
            })
    ...
    def _get_observations(self):
        ...
        for current_agent_name in self.agents:

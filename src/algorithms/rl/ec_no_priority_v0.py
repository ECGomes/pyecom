...
class EnergyCommunityBaselineV7(MultiAgentEnv):
    """
    This environment is designed to
    simulate an energy community with multiple agents.
    Reward is given only when a day ends
    There is no priority, action are simultaneous
    """

    metadata = {'name': 'EnergyCommunityBaseline-v7'}
    ...
    def step(self, action_dict: dict) -> tuple:
        ...
        if len(action_dict) > 0:
            ...
            for agent_name in new_action_dict:

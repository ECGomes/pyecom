...
class EnergyCommunityFixedPriorityV0(MultiAgentEnv):
    """
    Based on an initially calculated priority, this environment is designed to
    simulate an energy community with multiple agents.
    Reward is given only when a day ends
    Priority is based on resource type and capacity and is static
    """

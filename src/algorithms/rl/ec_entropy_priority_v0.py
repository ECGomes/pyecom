...
class EnergyCommunityEntropyPriorityV0(MultiAgentEnv):
    ...
    metadata = {'name': 'EnergyCommunityEntropyPriority-v0'}
    ...
    def _reset(self):
        ...
        # Create the entropy weighting priority dictionary for priority calculation
        priority_dict = self.create_entropy_dict()
